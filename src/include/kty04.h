...
static const groupsig_description_t kty04_description = {
  ...
  1, /**< KTY04 has a GML. */
  1, /**< KTY04 does have CRL. */
  0, /**< KTY04 does not use PBC. */
  0, /**< KTY04 does not have verifiable openings. */
...
/**
 * @fn int kty04_init()
 * @brief Initializes the internal variables needed by KTY04.
 *
...
/**
 * @fn int kty04_clear()
 * @brief Frees the memory initialized by kty04_init.
 *
 * @return IOK or IERROR.
 */
...
/**
 * @fn int kty04_sign(groupsig_signature_t *sig, message_t *msg,
 ...
 * @return IOK or IERROR.
 */
int kty04_verify(uint8_t *ok, groupsig_signature_t *sig,
 ...
 */
int kty04_open(uint64_t *id, groupsig_proof_t *proof, crl_t *crl,
...
static const groupsig_t kty04_groupsig_bundle = {
  desc: &kty04_description, /**< Contains the KTY04 scheme description. */
  ...
  sign: &kty04_sign, /**< Issues KTY04 signatures. */
  verify: &kty04_verify, /**< Verifies KTY04 signatures. */
  open: &kty04_open, /**< Opens KTY04 signatures. */
  open_verify: NULL, /**< KTY04 does not create proofs of opening. */
  reveal: &kty04_reveal, /**< Reveals the tracing trapdoor from KTY04 signatures. */
  trace: &kty04_trace, /**< Traces the issuer of a signature. */
  claim: &kty04_claim, /**< Claims, in ZK, "ownership" of a signature. */
  claim_verify: &kty04_claim_verify, /**< Verifies claims. */
  prove_equality: &kty04_prove_equality, /**< Issues "same issuer" ZK proofs for several signatures. */
  prove_equality_verify: &kty04_prove_equality_verify, /**< Verifies "same issuer" ZK proofs. */
  blind: NULL,
  convert: NULL,
  unblind: NULL,
  identify: NULL,
