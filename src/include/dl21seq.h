 ...
 * @return IOK or IERROR.
 */
int dl21seq_sign(groupsig_signature_t *sig, message_t *msg,
                 groupsig_key_t *memkey,
                 groupsig_key_t *grpkey, unsigned int seed);
 ...
 * @return IOK or IERROR.
 */
int dl21seq_verify(uint8_t *ok, groupsig_signature_t *sig,
                   message_t *msg,
                   groupsig_key_t *grpkey);
...
static const groupsig_t dl21seq_groupsig_bundle = {
 ...
 get_joinseq: &dl21seq_get_joinseq, /**< Returns the number of messages in the join protocol. */
 ...
 convert: NULL,
 unblind: NULL,
 identify: &dl21seq_identify, /**< Determines whether a signature has been issued by a member. */
 ...
 verify_seqlink: &dl21seq_verify_seqlink, /**< Verifies a proof of sequential link. */
};
