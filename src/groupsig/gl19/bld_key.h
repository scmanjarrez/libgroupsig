...
/**
 * @fn int gl19_bld_key_pub(groupsig_key_t *key, groupsig_key_t **pub)
 ...
 * @return IOK or IERROR.
 */
int gl19_bld_key_pub(groupsig_key_t *key, groupsig_key_t **pub);
...
/**
 * @fn int gl19_bld_key_pub(groupsig_key_t *key, groupsig_key_t **prv)
 ...
 * @return IOK or IERROR.
 */
int gl19_bld_key_prv(groupsig_key_t *key, groupsig_key_t **prv);
...
static const bld_key_handle_t gl19_bld_key_handle = {
 ...
 .gexport_prv = &gl19_bld_key_export_prv, /**< Exports the private part of a
					   blinding key. */
 .pub = &gl19_bld_key_pub, /**< Create a new blinding key with only the public part. */
 .prv = &gl19_bld_key_prv, /**< Create a new blinding key with only the private part. */
